...
print(data.head(5))
print(data.shape)
print(pd.Series(data.Fare.unique()).sort_values())
...
print(data.loc[index,'Fare'].sort_values())
...
# Windsorization
# top-coding & bottom coding (capping the maximum of a distribution
# at an arbitrarily set value,vice versa)
# -------------------------------------------------------------------------------------------==
# use any of the detection method above
