# =================================================================================
# Arwa Ashi - HW1 - Week 11 - Nov 15, 2020
# Saudi Digital Academy
# Machine Learning
# =================================================================================
# Assignment ML
# Modify the heuristic model to a basic quantitative model.
# =================================================================================
...
# Fixing Date
# period indicates that 0 is the first day in the history recored 1948-01-01
# ---------------------------------------------------------------------------------
Firstday     = dt.date(1948,1,1)
df['DATE']   = pd.to_datetime(df['DATE']).dt.date
df['period'] = df['DATE'].apply(lambda x: (x - Firstday).days)
print(df.head())
...
Regr_model = reg.fit(X_train, y_train)
print (Regr_model.score(X_test,y_test))

# Coefficients for all the attributes
# ---------------------------------------------------------------------------------
...
reg_df  = pd.DataFrame({'Actual Numbers': y_test, 'Predicted': y_pred})  
print (Regr_model.score(X_test,y_test))
print(reg_df.head())
print(reg_df)
...
print('Coefficient of determination for a basic quantitative model : %.2f'% r2_score(y_test, y_pred))
